...
function cargarProductos() {
    ...
    productos.forEach(producto => {
        ...
        row.innerHTML = `
            ...
            <td>
            <button onclick="editarProducto(${producto.id})"><iconify-icon icon="bxs:pencil" style="color: #1d84b5;"></iconify-icon></button>
            <button onclick="eliminarProducto(${producto.id})"><iconify-icon icon="bxs:trash" style="color: #f33;"></iconify-icon></button>
